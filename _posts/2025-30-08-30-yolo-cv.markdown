...
To enable training on Apple silicon chips, I use `mps`.
...
This points to a potential gap in labeling of training data. It may be helpful to create training data that provides the level of detail we want the model to learn. It could also mean the model needs more time to learn to delineate between trees.
